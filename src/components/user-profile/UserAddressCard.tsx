          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
              <div>
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">Iran</p>
              </div>

              <div>
                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">City/State</p>

                <p className="text-sm font-medium text-gray-800 dark:text-white/90">Qom</p>
              </div>

              <div>
                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Postal Code</p>

                <p className="text-sm font-medium text-gray-800 dark:text-white/90">3719678546</p>
              </div>

              <div>
                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">TAX ID</p>

                <p className="text-sm font-medium text-gray-800 dark:text-white/90">SA2471383</p>
              </div>
            </div>
          </div>
            ...
            <div className="px-2 overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                ...
                <div>
                  ...
                  <Input type="text" defaultValue="Qom" />
                </div>

                <div>
                  <Label>Postal Code</Label>

                  <Input type="text" defaultValue="3719678546" />
                </div>

                <div>
                  <Label>TAX ID</Label>

                  <Input type="text" defaultValue="SA2471383" />
                </div>
              </div>
            </div>
