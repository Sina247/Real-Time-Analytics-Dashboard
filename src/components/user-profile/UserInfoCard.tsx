        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">Sina</p>
            </div>

            <div>
              <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Last Name</p>

              <p className="text-sm font-medium text-gray-800 dark:text-white/90">Ahmadi</p>
            </div>

            <div>
              <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Email address</p>

              <p className="text-sm font-medium text-gray-800 dark:text-white/90">sina247re@gmail.com</p>
            </div>

            <div>
              <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Phone</p>

              <p className="text-sm font-medium text-gray-800 dark:text-white/90">+98 0919 150 1293</p>
            </div>

            <div>
              <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Bio</p>

              <p className="text-sm font-medium text-gray-800 dark:text-white/90">Frontend Developer</p>
            </div>
          </div>
        </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div>
                    ...
                    <Input type="text" defaultValue="https://www.facebook.com/Sina247" />
                  </div>

                  <div>
                    <Label>X.com</Label>

                    <Input type="text" defaultValue="https://x.com/Sina247" />
                  </div>

                  <div>
                    <Label>Linkedin</Label>

                    <Input type="text" defaultValue="https://www.linkedin.com/company/Sina247" />
                  </div>

                  <div>
                    <Label>Instagram</Label>

                    <Input type="text" defaultValue="https://instagram.com/Sina247"/>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <Input type="text" defaultValue="Sina" />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Last Name</Label>

                    <Input type="text" defaultValue="Ahmadi" />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Email Address</Label>

                    <Input type="text" defaultValue="sina247re@gmail.com" />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Phone</Label>

                    <Input type="text" defaultValue="+98 0919 150 1293" />
                  </div>
