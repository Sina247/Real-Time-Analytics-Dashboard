        ...
        <form className="">
          ...
          <div className="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-2">
            <div className="col-span-1">
              ...
              <Input type="text" placeholder="Sina" />
            </div>

            <div className="col-span-1">
              <Label>Last Name</Label>

              <Input type="text" placeholder="Ahmadi" />
            </div>

            <div className="col-span-1">
              <Label>Last Name</Label>

              <Input type="email" placeholder="sina247re@gmail.com" />
            </div>

            <div className="col-span-1">
              <Label>Phone</Label>

              <Input type="text" placeholder="+98 0919 150 1293" />
            </div>
