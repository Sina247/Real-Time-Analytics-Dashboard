...
export default function DefaultInputs() {
  ...
  const options = [ { value: "marketing", label: "Marketing" }, { value: "template", label: "Template" }, { value: "development", label: "Development" } ];
  const handleSelectChange = (value: string) => {console.log("Selected value:", value);};
  ...
  return (
    <ComponentCard title="Default Inputs">
      <div className="space-y-6">
        ...
        <div>
          <DatePicker id="date-picker" label="Date Picker Input" placeholder="Select a date" onChange={(dates, currentDateString) => {console.log({ dates, currentDateString });}} />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <Input type="text" placeholder="Card number" className="pl-15.5" />
