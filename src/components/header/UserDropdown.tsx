  ...
  return (
    <div className="relative">
      <button onClick={toggleDropdown}  className="flex items-center text-gray-700 dark:text-gray-400 dropdown-toggle">
        ...
        <span className="block mr-1 font-medium text-theme-sm">Sina</span>
      ...
      <Dropdown isOpen={isOpen} onClose={closeDropdown} className="absolute right-0 mt-4.25 flex w-65 flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark">
        <div>
          <span className="block font-medium text-gray-700 text-theme-sm dark:text-gray-400">Sina Ahmadi</span>

          <span className="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">sina247re@gmail.com</span>
        </div>
