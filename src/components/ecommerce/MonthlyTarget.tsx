      ...
      <div className="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
        <div className="flex justify-between">
          <div>
            ...
            <p className="mt-1 font-normal text-gray-500 text-theme-sm dark:text-gray-400">Target you have set for each month</p>
          </div>
        ...
        <p className="mx-auto mt-10 w-full max-w-95 text-center text-sm text-gray-500 sm:text-base">You earn $3287 today, it&apos;s higher than last month. Keep up your good work!</p>
      </div>
